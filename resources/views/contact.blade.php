        ...
        <div class="max-w-4xl mx-auto">
            ...
            <form action="{{route('contact.store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div>
                 ...
                 <div>
                    <label class="text-(--primary) font-semibold" for="image">Image</label>
                    <input class="border w-full" type="file" name="image" id="image">
                </div>
                <button class="bg-(--primary) hover:bg-(--secondary) mt-3 py-5 px-7 rounded-xl text-white font-semibold duration-300" type="submit">Submit </button>
            </form >
        </div>
    </section>
</x-frontend-layout>
